...
Instead of editing pages on separate sites Carbon Free websites can be edited directly in the same application using our low code editor Quell. Editing within the same app eliminates all emissions that would otherwise occur from third party apps like Github editing that lack actionable intelligance for emissions of services. By eliminating expose to outside players without emissions we can significantly reduce emissions by avoiding these services in place of our own.

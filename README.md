...
Carbon Free website pages can be published and edited directly in the same application using our low code editor Quell. Editing within the same app eliminates all emissions that would otherwise occur from third party apps like Github editing that lack actionable intelligance for emissions of services. Carbon free websites track and monitor electricity and emissions in real time.
